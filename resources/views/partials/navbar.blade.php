<header class="header header-sticky p-0 mb-4">
    <div class="container-fluid border-bottom px-4">
        ...
        <form class="d-none d-md-block ms-3 flex-grow-1" role="search" style="max-width: 420px">
            <input class="form-control" type="search" placeholder="Search users, orders, reports" aria-label="Search">
        </form>

        <ul class="header-nav ms-auto">
            <li class="nav-item dropdown me-1 me-md-2">
                <button class="btn btn-link nav-link py-2 px-2" type="button" aria-expanded="false" data-coreui-toggle="dropdown">
                    <svg class="icon icon-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <div class="dropdown-menu dropdown-menu-end notification-menu" style="--cui-dropdown-min-width: 18rem">
                    <div class="dropdown-header fw-bold text-body">Notifications</div>
                    <a class="dropdown-item" href="#">
                        <span class="d-block">New user registered</span>
                        <small class="text-body-secondary">4 minutes ago</small>
                    </a>
                    <a class="dropdown-item" href="#">
                        <span class="d-block">Revenue target reached</span>
                        <small class="text-body-secondary">32 minutes ago</small>
                    </a>
                    <a class="dropdown-item" href="#">
                        <span class="d-block">Security review completed</span>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link py-0 pe-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar avatar-md">
                        <img class="avatar-img" src="{{ asset('coreui/assets/img/avatars/8.jpg') }}" alt="{{ Auth::user()->name ?? 'Admin' }}">
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    <div class="dropdown-header bg-body-tertiary text-body-secondary fw-semibold rounded-top mb-2">{{ Auth::user()->name ?? 'Admin Hasan' }}</div>
                    <a class="dropdown-item" href="{{ route('profile') }}">
                        <i class="cil-user me-2" aria-hidden="true"></i>
                        Profile
                    </a>
                    <a class="dropdown-item" href="#">
                        <i class="cil-settings me-2" aria-hidden="true"></i>
                        Account settings
                    </a>
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        ...
                        <button type="submit" class="dropdown-item text-danger">
                            <i class="cil-account-logout me-2" aria-hidden="true"></i>
                            Sign out
                        </button>
                    </form>
                </div>
