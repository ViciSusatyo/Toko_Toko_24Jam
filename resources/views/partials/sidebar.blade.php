<div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
    <div class="sidebar-header border-bottom">
        <a class="sidebar-brand me-auto" href="{{ route('dashboard') }}">
    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('dashboard') ? 'active' : '' }}" href="{{ route('dashboard') }}" @if(request()->routeIs('dashboard')) aria-current="page" @endif>
                <i class="cil-speedometer nav-icon" aria-hidden="true"></i>
                Dashboard
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="cil-people nav-icon" aria-hidden="true"></i>
                Users
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="cil-user-plus nav-icon" aria-hidden="true"></i>
                Add User
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('profile') ? 'active' : '' }}" href="{{ route('profile') }}" @if(request()->routeIs('profile')) aria-current="page" @endif>
                <i class="cil-user nav-icon" aria-hidden="true"></i>
                Profile
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="cil-chart nav-icon" aria-hidden="true"></i>
                Charts
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="cil-grid nav-icon" aria-hidden="true"></i>
                Tables
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="cil-list nav-icon" aria-hidden="true"></i>
                Forms
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="cil-puzzle nav-icon" aria-hidden="true"></i>
                Components
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="cil-bell nav-icon" aria-hidden="true"></i>
                Alerts
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="cil-window nav-icon" aria-hidden="true"></i>
                Modals
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="cil-settings nav-icon" aria-hidden="true"></i>
                Settings
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="cil-file nav-icon" aria-hidden="true"></i>
                Blank Page
            </a>
        </li>
    </ul>
    ...
    <div class="sidebar-footer">
        <div class="d-flex align-items-center gap-2">
            <div class="avatar avatar-lg">
                <img class="avatar-img" width="44" height="44" src="{{ asset('coreui/assets/img/avatars/1.jpg') }}" alt="{{ Auth::user()->name ?? 'Admin' }}">
            </div>
            <div class="overflow-hidden">
                <strong class="d-block text-truncate">{{ Auth::user()->name ?? 'Admin Hasan' }}</strong>
                <small class="text-body-secondary text-truncate">{{ Auth::check() ? (Auth::user()->email ?? 'Active Workspace') : 'Active Workspace' }}</small>
            </div>
        </div>
    </div>
</div>