...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="{{ asset('images/landing/favicon.ico') }}" />
    <!-- Bootstrap icons-->
...
<body>
    ...
    <nav class="navbar navbar-light bg-light static-top">
        <div class="container">
            <a class="navbar-brand" href="#!">Test Landing Page</a>
            <a class="btn btn-primary" href="{{ route('login') }}">Login</a>
            
        </div>
    </nav>
    <!-- Masthead-->
    <header class="masthead" style="background-image: url('{{ asset('images/landing/bg-masthead.jpg') }}');">
        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                <div class="col-lg-6 order-lg-2 text-white showcase-img"
                    style="background-image: url('{{ asset('images/landing/bg-showcase-1.jpg') }}')"></div>
            ...
            <div class="row g-0">
                <div class="col-lg-6 text-white showcase-img"
                    style="background-image: url('{{ asset('images/landing/bg-showcase-2.jpg') }}')"></div>
            ...
            <div class="row g-0">
                <div class="col-lg-6 order-lg-2 text-white showcase-img"
                    style="background-image: url('{{ asset('images/landing/bg-showcase-3.jpg') }}')"></div>
                <div class="col-lg-6 order-lg-1 my-auto showcase-text">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                        <img class="img-fluid rounded-circle mb-3" src="{{ asset('images/landing/testimonials-1.jpg') }}"
                            alt="..." />
                        <h5>Margaret E.</h5>
                ...
                <div class="col-lg-4">
                    <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                        <img class="img-fluid rounded-circle mb-3" src="{{ asset('images/landing/testimonials-2.jpg') }}"
                            alt="..." />
                        <h5>Fred S.</h5>
                ...
                <div class="col-lg-4">
                    <div class="testimonial-item mx-auto mb-5 mb-lg-0">
                        <img class="img-fluid rounded-circle mb-3" src="{{ asset('images/landing/testimonials-3.jpg') }}"
                            alt="..." />
                        <h5>Sarah W.</h5>
    ...
    <!-- Call to Action-->
    <section class="call-to-action text-white text-center" id="signup" style="background-image: url('{{ asset('images/landing/bg-masthead.jpg') }}');">
        <div class="container position-relative">
            <div class="row justify-content-center">
                <div class="col-xl-6">
